...
import { aquestion } from './questions/Anxietyq';
...
function AnxietyTest() {
    ...
    const handleTrigger = ()=>{
        ...
        for(let i=0;i<objectLength;i++){
            ...
            let optionBox = aquestion[i].options
    ...
    <div>
        ...
        <h2 className='hed'>Anxiety Test</h2>
            ...
            <form className='form'>
                <h2 className='subhead' style={{fontFamily:"serif"}}>Anxiety: GAD-7</h2>
                {aquestion.map(getquestion)} <br />  
                <Link to='/tests/anxietyscore'>              
